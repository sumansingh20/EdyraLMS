  ...
  return (
    <LMSLayout
      ...
      breadcrumbs={[
        ...
        { label: question.questionText.slice(0, 40) + (question.questionText.length > 40 ? '...' : '') },
      ]}
    >
      <div style={{ maxWidth: 900, margin: '0 auto' }}>
            ...
            <div style={{ padding: 16 }}>
              {question.questionType === 'numerical' && question.answerTolerance ? (
                <p style={{ fontSize: 15, fontWeight: 600 }}>
                  {String(question.correctAnswer)} <span style={{ fontSize: 13, fontWeight: 400, color: 'var(--text-muted)' }}>( +/- {question.answerTolerance} tolerance)</span>
                </p>
        ...
        <div style={{ display: 'flex', gap: 8, marginBottom: 32 }}>
          ...
          <Link href="/admin/questions" className="lms-btn lms-btn-primary" style={{ padding: '8px 20px', textDecoration: 'none' }}>All Questions</Link>
        </div>
      </div>
    </LMSLayout>
  );
